...
class BsdConnector(context: Context, listener: DeviceManagerListener<AntDevice.BsdDevice>): AntDeviceConnector<AntPlusBikeSpeedDistancePcc, AntDevice.BsdDevice>(context, listener) {
